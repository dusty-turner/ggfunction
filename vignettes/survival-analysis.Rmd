...
a simultaneous Greenwood confidence band, and "+" marks at censoring times.
...
`geom_echf_na()` renders this as an increasing step function with a simultaneous
confidence band based on the variance estimator
