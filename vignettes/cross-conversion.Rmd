...
|------|----------------|------------|
| `geom_pdf()` | PDF | `cdf_fun` (differentiate), `survival_fun` ($1 - S$ then differentiate), `qf_fun` (interpolate then differentiate) |
| `geom_cdf()` | CDF | `pdf_fun` (integrate), `survival_fun` ($1 - S$), `qf_fun` (interpolate) |
