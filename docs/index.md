...
bivariate density through its highest density regions or as a raw
density raster. It is a thin wrapper around
[**ggdensity**](https://jamesotto852.github.io/ggdensity/) for HDRs: the
function is supplied in **ggfunction**’s `fun(c(x, y))` convention and
adapted internally, while HDR computation, probability labels, and
default aesthetics are delegated to
...
![](reference/figures/readme-pdf-2d-raster-1.png)
