...
An object of class `StatCDFDiscrete` (inherits from `Stat`, `ggproto`,
`gg`) of length 3.

An object of class `GeomCDFDiscrete` (inherits from `Geom`, `ggproto`,
`gg`) of length 5.
...
- fun:
  ...
  of `fun` or `pmf_fun` must be provided.
