...
highest density regions. It is a thin wrapper around
...
aesthetics are delegated to `ggdensity::geom_hdr_fun()` (filled regions,
the default `type = "hdr"`) or `ggdensity::geom_hdr_lines_fun()`
