...
\hline
\texttt{geom\_pdf()} & PDF & \texttt{cdf\_fun}, \texttt{survival\_fun}, \texttt{qf\_fun}\\
\hline
\texttt{geom\_cdf()} & CDF & \texttt{pdf\_fun}, \texttt{survival\_fun}, \texttt{qf\_fun}\\
\hline
