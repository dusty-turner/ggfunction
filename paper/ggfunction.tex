...
The PP layer expects a CDF by default, while the QQ layer expects a quantile
function; alternate function sources are converted internally using the same
CDF/QF helpers used by the theoretical distribution geoms.
