...
cc <- data.frame(
  Geom = c(
    ...
    "\\texttt{geom\\_hf()}", "\\texttt{geom\\_cdf\\_discrete()}",
    "\\texttt{geom\\_survival\\_discrete()}", "\\texttt{geom\\_qf\\_discrete()}"
  ),
  Native = c("PDF", "CDF", "Survival", "Quantile", "Hazard",
             "CDF", "Survival", "Quantile"),
  Alternates = c(
    "\\texttt{cdf\\_fun}, \\texttt{survival\\_fun}, \\texttt{qf\\_fun}",
    "\\texttt{pdf\\_fun}, \\texttt{survival\\_fun}, \\texttt{qf\\_fun}",
