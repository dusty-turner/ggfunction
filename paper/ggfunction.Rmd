...
abstract: >
  ...
  function with the inverted KS band, one-sample PP and QQ diagnostic plots with
  DKW bands under a fully specified null distribution, the empirical PMF as a
...
Michael [-@michael1983stabilized] discusses acceptance regions for PP, QQ, and
...
- **PP and QQ diagnostics** sort finite observations, compute plotting positions with `stats::ppoints(n, a = 1/2)`, and derive their DKW bands from the same half-width as `geom_ecdf()`. The QQ ribbon transforms the probability-scale band through the supplied or derived quantile function.
