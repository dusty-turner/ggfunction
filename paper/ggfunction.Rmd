...
```{r pdf-hdr, echo=TRUE}
#| fig.cap: "The 90\\% highest density region of a bimodal density, shading both modes as two disjoint intervals."
...
For discrete distributions, the CDF is a step function. `geom_cdf_discrete()` takes a PMF as input, computes cumulative sums, and renders the result as a right-continuous step function with dashed vertical jumps and open/closed endpoint circles.
