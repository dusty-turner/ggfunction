...
**Viridis fill.** Mapping the mass to `fill` as well, with a fillable point shape, pairs the size encoding with a perceptually uniform viridis palette for higher contrast.
