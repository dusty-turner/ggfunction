...
**Spectral scale.** For sight-typical users, the rainbow palette can be an effective tool to better visualize the variables not shown ($x$ or $p$ in PP or QQ plots, respectively).
