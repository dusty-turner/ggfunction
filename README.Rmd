...
**ggfunction** extends [ggplot2](https://ggplot2.tidyverse.org/) with geom layers for plotting mathematical functions and probability distributions directly --- no need to pre-compute data frames.
...
Plot any univariate function. Behaves like `ggplot2::geom_function()` but supports interval shading via `shade_from` / `shade_to`.
