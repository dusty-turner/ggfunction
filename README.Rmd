...
**Raw density raster.** `type = "raster"` plots the evaluated density grid directly. The default fill is fixed dark gray and alpha varies with the density value.
