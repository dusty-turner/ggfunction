...
**Viridis HDR fill.** If the alpha encoding is too subtle, map the HDR levels to `fill` with a discrete viridis palette instead, fixing `alpha = 1` to turn off the default encoding; the points use a fillable shape by default. Probability mass stays encoded by point size.
